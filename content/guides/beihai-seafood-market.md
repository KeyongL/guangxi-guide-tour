...
Buy your own raw seafood at a Beihai market stall, then carry it to a nearby restaurant that cooks it for a per-jin fee. That is the whole system. You eat well and cheap if you do three things: agree the price per jin (500g) before the vendor weighs anything, watch the scale, and confirm the cooking fee up front in writing. Skip any of those and you get the tourist markup. Beihai sits inside the 240-hour transit visa-free zone, so most short-stay travellers reach it without a visa. This is a food guide, not legal advice.

## How the buy-then-cook system works

Two steps, two payments. First you walk the market and buy live seafood by weight at a stall. Prices are quoted per jin (斤 = 500g), not per kilo, so a "50" sign means ¥50 per 500g. Second you take your bag to a processing restaurant (加工店), pick how you want each item cooked, and pay a separate cooking fee. The raw cost goes to the stall; the cooking fee goes to the restaurant. Keep them separate in your head, because scams hide in the gap between them.

## Don't get scammed: agree price and weight first

The classic tricks are all about weight and vague pricing. Protect yourself:

- **Agree the per-jin price out loud before anything goes on the scale.** Point at the sign or make the vendor say the number.
- **Watch the scale.** Rigged scales and a wet thumb on the pan are the oldest moves. Many markets have a public checking scale (公平秤) near the entrance. Use it. If your bag weighs less than you paid for, go back.
- **Refuse "wild-caught" upsells with no posted price.** A stall that won't show a number is the one to walk away from.
- **Ignore taxi and tout recommendations.** Drivers steering you to a "cheap" seafood restaurant are usually paid on commission.
- **Confirm the cooking fee in writing before they cook.** Get each dish and its fee written down, e.g. steamed ¥10, salt-and-pepper fried ¥15. No verbal quotes.
